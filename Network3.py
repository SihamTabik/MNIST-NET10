...
def crop(img, size):#Function to crop an image
        n = len(img) - size
...
def augmentate_2(images, labels, alpha, sigma):
        images = images.reshape(images.shape[0], 1,20,20)
        deformated, new_labels = getElastics(images, labels,alpha, sigma)
	print(len(deformated))
	print(deformated.shape)
        deformated = deformated.reshape(deformated.shape[0], 20, 20,1)
...
#X_train = preprocessing.image.ImageDataGenerator(rotation_range=2.0)
...
def experiment_2(X_train, Y_train, file):
        model = Sequential()
        ...
        model.fit(X_train, Y_train,  batch_size=128, nb_epoch=50, verbose=0)

        print("Start evaluation...")
        score = model.evaluate(X_test_org, Y_test, verbose=0)

        print(score)

        preds = model.predict( X_test_org, batch_size=None, verbose=0)
...
#experiment_2(X_train_org, Y_train_org, './models_org/modelo1_60.h5')
#experiment_2(X_train_org, Y_train_org, './models_org/modelo2_60.h5')
#experiment_2(X_train_org, Y_train_org, './models_org/modelo3_60.h5')
#experiment_2(X_train_org, Y_train_org, './models_org/modelo4_60.h5')
#experiment_2(X_train_org, Y_train_org, './models_org/modelo5_60.h5')

print("ENTRENAMIENTO AUMENTO ALEATORIO")


#experiment(X_train_random, Y_train_random, './models_random_noRep/modelo1_60.py')
#experiment(X_train_random, Y_train_random, './models_random_noRep/modelo2_60.py')
#experiment(X_train_random, Y_train_random, './models_random_noRep/modelo3_60.py')
#experiment(X_train_random, Y_train_random, './models_random_noRep/modelo4_60.py')
#experiment(X_train_random, Y_train_random, './models_random_noRep/modelo5_60.py')

print("ENTRENAMIENTO ENCADENADO")

#experiment(X_train_enc, Y_train_enc, './models_random_encadenado/modelo1_60.py')
#experiment(X_train_enc, Y_train_enc, './models_random_encadenado/modelo2_60.py')
#experiment(X_train_enc, Y_train_enc, './models_random_encadenado/modelo3_60.py')
#experiment(X_train_enc, Y_train_enc, './models_random_encadenado/modelo4_60.py')
#experiment(X_train_enc, Y_train_enc, './models_random_encadenado/modelo5_60.py')
...
#experiment(X_train_2, Y_train_2, './models_random_elastic/modelo1.h5')
#experiment(X_train_2, Y_train_2, './models_random_elastic/modelo2.h5')
#experiment(X_train_2, Y_train_2, './models_random_elastic/modelo3.h5')
#experiment(X_train_2, Y_train_2, './models_random_elastic/modelo4.h5')
#experiment(X_train_2, Y_train_2, './models_random_elastic/modelo5.h5')
#TODO:arreglar esto
